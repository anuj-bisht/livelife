		...
		<div class="container-fluid">
            ...
            <div class="tab-content">
                <div id="main" class="tab-pane fade in active">
                    <form method="POST" action="{{ url('/') }}/admin/videos/store" id="videosFormData">
                    @csrf
                    <div class="row">                        
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Name:</strong>
                                {!! Form::text('name', "", array('placeholder' => 'Video Name' , 'class' => 'form-control')) !!}
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Categories:</strong>
                        {!! Form::select('category_id', $categories, "", array('placeholder' => 'Categories','class' => 'form-control','id'=>'category_id')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('code', "", array('placeholder' => 'Youtube code','class' => 'form-control')) !!}
                    </div>
                </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>description:</strong>
                                {!! Form::textarea('description', "", array('placeholder' => 'Video description','class' => 'form-control')) !!}
                            </div>
                        </div>                                                                                        
                        <div class="col-xs-12 col-sm-12 col-md-12">                            
...
$(function(){
  ...
  //pass lavel id
    ...
    url: "{{url('/')}}/admin/videos/uploadFiles/6",
    maxFileSize: 30000000000000, // 3 Megs 
    
    headers: {
                'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
              },
    data:$('#videosFormData').serialize(),
...
function videolist1(data)
{
    
    var id = data.data.id;
    jQuery.ajax({        
        type : 'POST',
        url : "{{url('/')}}/admin/videos/store",
        data : {'id':id},
        beforeSend: function(xhr){xhr.setRequestHeader('X-CSRF-TOKEN', $('meta[name="csrf-token"]').attr('content'));},
        success: function (data) {
            // videolist('6');            
