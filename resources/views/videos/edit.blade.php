            ...
            <div class="tab-content">
                <div id="main" class="tab-pane fade in active">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id', $categories, $selectedCatId->category_id, array('placeholder' => 'Categories','class' => 'form-control','id'=>'category_id')) !!}
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('code', $video->youtube, array('placeholder' => 'Youtube code','class' => 'form-control')) !!}
                    </div>
                </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
...
$(document).ready(function(){
        ...
        var selVal = {{$selectedCatId->category_id}};
        // console.log(selVal);
        // alert('hii');
        var levelId = {{$video->level_id}};
        if(selVal=="" || selVal=="0"){
            jQuery.alert({
                    title: 'Alert!',
...
$(function(){
  ...
  $('#drag-and-drop-zone').dmUploader({ //
    url: "{{url('/')}}/admin/videos/uploadFiles/{{$video->id}}",
