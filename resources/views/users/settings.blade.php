	...
	<div id="page-wrapper">
      ...
      <div class="row">
			...
			<form class="form-horizontal form-label-left" action="{{ url('/') }}/admin/users/settings/1" method="POST">
				  ...
				  <div class="form-group" style="float:left">
					<label for="content" class="col-sm-12 control-label">Trining Type for LFL</label>
				  </div>
				  <div class="form-group">                        
					<div class="col-md-12 col-sm-12 col-xs-12">
						<input class="form-control" type="checkbox" name="online_training" value='Y' @if($settings->online_training=='Y') checked @endif>Online Training
						<input class="form-control" type="checkbox" name="virtual_training" value='Y' @if($settings->virtual_training=='Y') checked @endif>Virtual Training
						<input class="form-control" type="checkbox" name="offline_training" value='Y' @if($settings->offline_training=='Y') checked @endif>Online Training
					</div>
				  </div>
