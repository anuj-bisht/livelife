...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Test Request List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">        
          ...
          <div class="form-group">
            ...
            <input type="text" readonly class="form-control datetimepicker" id="assign_slot" name="assign_slot">
          ...
          table = jQuery('#tableData').DataTable({
            ...
            'fnRowCallback': function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
              if (aData["status"] == "Y") {
                ...
                jQuery('td', nRow).css('background-color', '#AA0000');
              }else if (aData["status"] == "A") {
                jQuery('td', nRow).css('background-color', '#bb7f7f');
              }
            ...
            'ajax': {
              'url': '{{ url("/") }}/admin/testrequests/ajaxData',
              'headers': {
            ...
            'columns': [
              {
                  ...
                  'render': function(data,type,row){
                    ...
                    return '<input type="checkbox" class="demo_chkbox" name="testrequest[]" value="'+row.id+'">';
                  }
              },               
              {
                  'data': 'name',
              ...
              },
              {
                  ...
                  'render': function(data,type,row){
                    ...
                    if(row.is_completed=='N'){
                      return 'New';  
                    }else if(row.is_completed=='Y'){
                      return 'Completed';
                    }else if(row.assign_to != 0){
                      return 'Assigned';
                    }else{
                      return 'Cancelled';
                    }
  ...
  $('.trainer-btn-action').on('click',function(){
      ...
      if(trainers.length==0){
        jQuery.alert({
            title: 'Alert!',
            content: 'Please select a test request checkbox!',
        });
        return false;
      }
  });
  ...
  $("#assign_trainer_form").submit(function(event){
      ...
      var post_url = "{{url('/')}}/admin/testrequests/assigntrainer"; 
