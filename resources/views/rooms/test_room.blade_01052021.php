			   ...
			   <script>
				$(document).ready(function(){
				    ...
				    function participantConnected(participant) {
				       ...
				       div.innerHTML = "<div style='position:absolute;top:87%;left:7%;z-index:1;'><p id='topText'>"+participant.identity+"</p></div>";
					...
					// function TrainerConnected(participant) {
				    //    //console.log('Participant "%s" connected', participant.identity);
					...
					$('#testrequest_model_form').submit(function(e){
						...
						$.ajax({
							...
							data: $('#testrequest_model_form').serialize(),           
					...
					function countdown(secs) {		
						...
						sendNotificationAjax('start',getParameterByName("uid"));
					...
					function stoptimer(){
						...
						clearInterval(counter);			
						  ...
						  sendNotificationAjax('stop',getParameterByName("uid"));
						  $('#exampleModal').modal('show');
						  $('#timervalue').val($('#timerdata').html());
						  $('#uid').val(getParameterByName("uid"));
						  
						  
						  /*var post_url = "{{url('/')}}/trainer/testrequests/testtimer"; 
						  ...
						  $.ajax({
							...
							data : {"uid":getParameterByName("uid"),"timerdata":$('#timerdata').html()},
							success: function(res){
							  $('#exampleModal').modal('hide'); 
							  table.draw();
							}
					...
					function sendNotificationAjax(type,uid){
						$.ajax({
