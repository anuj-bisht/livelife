...
<style>
	...
	<div class="navbar-default sidebar" role="navigation" >
		<div class="sidebar-nav " style="overflow: auto;max-height: 73% !important">
			<ul class="nav" id="side-menu">
				...
				<li>
					...
					<ul class="nav nav-second-level">
						<li>
							<a href="{{ url('/') }}/admin/batches">Batch List</a>
						</li>	
						<li>
				...
				<li>
					<a href="#"><i class="fa fa-files-o fa-fw"></i> Chat Management <span id="chatCount"></span><span class="fa arrow" ></span></a>
					<ul class="nav nav-second-level">
