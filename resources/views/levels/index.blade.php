...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Levels List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ url('/') }}/admin/levels/create"> Create New level</a>
            </div>
        </div>
      </div>
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['levels.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
            ...
            'columns': [
              ...
              },
              {
                  ...
                  'render': function(data,type,row){           
                    ...
                    return '<input type="radio" name="default" '+selected+' onclick="setDefault('+row.id+')">';
                  }
              },
              {
                  'data': 'duration',
              ...
              },            
              {
                ...
                'className': 'col-md-3',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/admin/levels/'+row.id+'/edit">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteRow').attr('action', url+"/admin/levels/"+id).submit();  
          },
          cancel: function () {
              return true;
          }
...
function setDefault(id){
    jQuery.ajax({        
        type : 'POST',
        url : "{{url('/')}}/admin/levels/setDefault",
        data : {'id':id},
