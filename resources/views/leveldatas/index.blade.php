...
@section('content')
	...
	<div id="page-wrapper">
      ...
      <div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">{{__('Level Data List')}}</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>  
      ...
      <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ url('/') }}/admin/leveldatas/create"> Create New Level Data</a>
            </div>
        </div>
      </div>
  ...
  {!! Form::open(['method' => 'DELETE','route' => ['leveldatas.destroy', 1],'id'=>'deleteRow','style'=>'display:inline']) !!}
  ...
  <script>
    ...
    jQuery(document).ready(function() {
          ...
          table = jQuery('#tableData').DataTable({
            ...
            'ajax': {
              'url': '{{ url("/") }}/admin/leveldatas/ajaxData',
              'headers': {
            ...
            'columns': [
              ...
              },
              {
                  ...
                  'render': function(data,type,row){
                    ...
                    return '<img src="'+row.image+'" style="max-width:150px;max-height:150px;">';
                  }
              },
              {
                  'data': 'code',
              ...
              },            
              {
                ...
                'className': 'col-md-2',
                'render': function(data, type, row) {
                  var buttonHtml = '<a class="btn btn-primary" href="'+url+'/admin/leveldatas/edit/'+row.id+'">Edit</a>&nbsp;&nbsp;<a class="btn btn-danger" href="javascript:void(0);" onclick="deleteData('+row.id+')">Delete</a>';
                  return buttonHtml;
                }
              }
            ]
...
function deleteData(id){
  ...
  $.confirm({
      ...
      buttons: {
          confirm: function () {
            $('#deleteRow').attr('action', url+"/admin/leveldatas/"+id).submit();  
          },
          cancel: function () {
              return true;
          }
