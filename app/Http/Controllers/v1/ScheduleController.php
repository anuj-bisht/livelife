      ...
      try{
        ...
        if($this->datecompare($scheduleData->start,date('Y-m-d H:i:s'))){
          ...
          if($obj->save()){
            ...
            $data['message1'] = 'Your reschedule request is captured with our system, Admin will take an action and will notify you soon.';
            ...
            $suscription_msg = "Your reschedule request is captured with our system, Admin will take an action and will notify you soon.";
