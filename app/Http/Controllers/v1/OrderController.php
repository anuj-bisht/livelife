  ...
  public function generateOrder(Request $request){
    ...
    try{
      ...
      if(isset($planData->id)){        
       $amount = (($request->price) ? $planData->price : $planData->price)*100; 
       //$amount = 100;
       $receipt = 'order_'.uniqid();
        
        if(Config('app.RAZOR_LIVE')){
          $key = Config('app.RAZOR_LIVE_KEY');
          $secret = Config('app.RAZOR_LIVE_SECRET');
        }else{
          $key = Config('app.RAZOR_TEST_KEY');
          $secret = Config('app.RAZOR_TEST_SECRET');
        }
            ...
            if(isset($orderData->id)){
              ...
              if(isset($subs_data->id)){
                ...
                if($this->confirmOrder($orderData->id,$subs_data->id)){
                  ...
                  if($diviceIds){
                    $suscription_title = "Subscription successfully updated";
                    $suscription_msg = "Your subscription is successfully updated";
                  ...
                  $data['message1'] = 'You renew subscription is added successfully, Thanks for the payment';
                ...
                $diviceIds = [$user->device_id];
                $suscription_title = "Subscription successfully added";
                $suscription_msg = "Your subscription is successfully added";
